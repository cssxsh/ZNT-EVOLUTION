...
- `AnimationLibrary` : `tk2dSpriteAnimation`
- `CommonAnimations` : `UnityDictionary<Animations, AnimationSettings>`
- `DefaultDeathAnimation` : `AnimationSettings`
- `HitAnimations` : `UnityDictionary<DamageType, AnimationSettings>`
- `DefaultHitAnimation` : `AnimationSettings`
- `DeathAnimations` : `UnityDictionary<DamageType, AnimationSettings>`
- `AirDeathAnimation` : `AnimationSettings`
- `AirDeathLandingAnimation` : `AnimationSettings`
- `assetId` : `string`
- `name` : `string`
...
- `CommonAnimations[Animations.Fall]` => `[fall]`
- `CommonAnimations[Animations.FallLandingLow]` =>
  `[fall_landing_low_1, fall_landing_low_2, fall_landing_low_3, fall_landing_low_4]`
- `CommonAnimations[Animations.FallLandingHigh]` =>
  `[fall_landing_high_1, fall_landing_high_2, fall_landing_high_3, fall_landing_high_4]`
