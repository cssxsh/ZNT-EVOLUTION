...
internal static class StartManagerPatch
{
    ...
    private static IEnumerator Initialize()
    {
        ...
        yield return CustomAssetUtility.LoadBuildIn<TMPro.TMP_Asset>(HandleAsset);
    ...
    private static void HandleAsset(CustomAsset asset)
    {
    ...
    private static void HandleAsset(TMPro.TMP_Asset asset)
    {
        switch (asset)
        {
    ...
    private static void HandlePatch(Shader shader)
    {
        CustomAssetUtility.Cache[shader.name] = shader;
        Logger.LogInfo($"Loaded Patch {shader}");
    }

    private static void HandlePatch(TMPro.TMP_Asset asset)
    {
        switch (asset)
        {
            case TMPro.TMP_FontAsset font:
